...
{
    /// <summary>
    /// This activity creates a new MatchData based off of information inputted by users on the scouting form while scouting a match.
    /// </summary>
    ...
    internal class ScoutForm: Activity
    {
        ...
        //Initialize radio button fields to false in case user does not change them.
        private int auto = 0;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //Get the current event and change the title text on the form.
        ...
        private void ButtonClicked(object sender, EventArgs e)
        {
            ...
            if ((sender as Button) == bFinish)
            {
                try
                {
                    ...
                    //Add the MatchData to the database.
